        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'flex-end' }} className="rg-hero-grid rg-contact-hero-grid">
          ...
          <Reveal delay={100}>
            <div style={{ borderLeft: `3px solid ${RG.teal}`, paddingLeft: 40 }}>
              {[
                { label: t('contactos.morada_label'), value: t('contactos.morada_val'), href: null, maps: 'https://maps.google.com/maps?q=Rua+Padre+Ant%C3%B3nio+Vieira+58%2C+8100-611+Loul%C3%A9' },
                ...
                <div key={i} style={{ paddingTop: i > 0 ? 28 : 0, paddingBottom: 28, borderBottom: i < 2 ? `1px solid ${RG.line}` : 'none' }}>
                  ...
                  {item.maps && (
                    <a href={item.maps} target="_blank" rel="noopener noreferrer" className="rg-maps-link" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginTop: 12, fontFamily: F_BODY, fontSize: 13, fontWeight: 700, color: RG.tealDark, textDecoration: 'none' }}>
