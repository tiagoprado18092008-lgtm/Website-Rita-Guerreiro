  ...
  PT: {
    ...
    contactos: {
      ...
      canais: {
        ...
        wa_placeholder: 'Escreve a tua mensagem…',
        wa_abrir: 'Abrir app',
        ...
        tel_body: 'Preferes falar? Liga durante o horário de funcionamento e tratamos tudo contigo.',
        tel_cta: 'Ligar agora',
        mapa_title: 'Mapa',
      },
      como_chegar: {
    ...
    service: {
      ...
      cta_heading_inline: 'Pronto para marcar a tua sessão?',
      steps: [
    ...
    meta: {
      ...
      sobre: { title: 'Sobre — Centro de Terapias Rita Guerreiro · Loulé', description: 'A equipa multidisciplinar da Clínica Rita Guerreiro em Loulé. Conhece a nossa história, missão e profissionais.' },
      contactos: { title: 'Contactos — Centro de Terapias Rita Guerreiro · Loulé', description: 'Contacta a Clínica Rita Guerreiro em Loulé. Telefone, WhatsApp, morada e horário.' },
  ...
  ES: {
    ...
    contactos: {
      ...
      canais: {
        ...
        wa_sem_app: '¿No tienes la app?',
        wa_download: 'Descargar ahora',
        wa_conversar: 'Chatear en WhatsApp con +351 961 899 364',
        tel_label: 'Llamada nacional',
        tel_body: '¿Prefieres hablar? Llama durante el horario de funcionamiento y lo organizamos todo contigo.',
    ...
    service: {
      ...
      cta_heading_inline: '¿Listo para reservar tu sesión?',
      steps: [
