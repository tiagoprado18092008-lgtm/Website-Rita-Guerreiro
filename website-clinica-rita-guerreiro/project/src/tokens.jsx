...
const TRANSLATIONS = {
  PT: {
    ...
    sobre: {
      ...
      team_members: [
        { name: 'Rita Guerreiro', role: 'Fundadora · Fisioterapeuta', bio: 'Fisioterapeuta e fundadora da clínica. Acredita num cuidado próximo, que trata a pessoa e não apenas o sintoma.', src: 'assets/rita-retrato.png' },
        { name: 'Nome do profissional', role: 'Osteopatia & ATM', bio: 'Lugar reservado para um novo membro da equipa. Em breve, mais um rosto dedicado ao seu bem-estar.', src: null },
        { name: 'Nome do profissional', role: 'Acupuntura & Terapias', bio: 'Lugar reservado para um novo membro da equipa. Em breve, mais um rosto dedicado ao seu bem-estar.', src: null },
        { name: 'Nome do profissional', role: 'Psicologia & Nutrição', bio: 'Lugar reservado para um novo membro da equipa. Em breve, mais um rosto dedicado ao seu bem-estar.', src: null },
      ],
  ...
  EN: {
    ...
    sobre: {
      ...
      team_members: [
        { name: 'Rita Guerreiro', role: 'Founder · Physiotherapist', bio: 'Physiotherapist and founder of the clinic. She believes in close, personal care that treats the person, not just the symptom.', src: 'assets/rita-retrato.png' },
        { name: 'Professional name', role: 'Osteopathy & TMJ', bio: 'A spot reserved for a new team member. Soon, another face dedicated to your well-being.', src: null },
        { name: 'Professional name', role: 'Acupuncture & Therapies', bio: 'A spot reserved for a new team member. Soon, another face dedicated to your well-being.', src: null },
        { name: 'Professional name', role: 'Psychology & Nutrition', bio: 'A spot reserved for a new team member. Soon, another face dedicated to your well-being.', src: null },
      ],
  ...
  FR: {
    ...
    sobre: {
      ...
      team_members: [
        { name: 'Rita Guerreiro', role: 'Fondatrice · Physiothérapeute', bio: 'Physiothérapeute et fondatrice de la clinique. Elle croit en un accompagnement proche, qui soigne la personne et non seulement le symptôme.', src: 'assets/rita-retrato.png' },
        { name: 'Nom du professionnel', role: 'Ostéopathie & ATM', bio: 'Une place réservée à un nouveau membre de l’équipe. Bientôt, un visage de plus dédié à votre bien-être.', src: null },
        { name: 'Nom du professionnel', role: 'Acupuncture & Thérapies', bio: 'Une place réservée à un nouveau membre de l’équipe. Bientôt, un visage de plus dédié à votre bien-être.', src: null },
        { name: 'Nom du professionnel', role: 'Psychologie & Nutrition', bio: 'Une place réservée à un nouveau membre de l’équipe. Bientôt, un visage de plus dédié à votre bien-être.', src: null },
      ],
      ...
      espaco_photos: [
        { src: '/assets/clinica/recepcao.jpg', label: 'Réception' },
  ...
  ES: {
    ...
    sobre: {
      ...
      team_members: [
        { name: 'Rita Guerreiro', role: 'Fundadora · Fisioterapeuta', bio: 'Fisioterapeuta y fundadora de la clínica. Cree en un cuidado cercano, que trata a la persona y no solo el síntoma.', src: 'assets/rita-retrato.png' },
        { name: 'Nombre del profesional', role: 'Osteopatía & ATM', bio: 'Un lugar reservado para un nuevo miembro del equipo. Pronto, un rostro más dedicado a tu bienestar.', src: null },
        { name: 'Nombre del profesional', role: 'Acupuntura & Terapias', bio: 'Un lugar reservado para un nuevo miembro del equipo. Pronto, un rostro más dedicado a tu bienestar.', src: null },
        { name: 'Nombre del profesional', role: 'Psicología & Nutrición', bio: 'Un lugar reservado para un nuevo miembro del equipo. Pronto, un rostro más dedicado a tu bienestar.', src: null },
      ],
