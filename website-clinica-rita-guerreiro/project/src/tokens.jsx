  ...
  PT: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Tânia Cavalheiro', role: 'Terapeuta de Bem-Estar · Especialista em Rosto', bio: 'Massagista formada pela Escola Europeia de Estética há 15 anos, com especialização em tratamentos faciais e drenagem linfática. Trabalhou nos melhores spas do Algarve.', src: '', bio_long: [], services: [] },
  ...
  EN: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Tânia Cavalheiro', role: 'Well-Being Therapist · Facial Specialist', bio: 'A massage therapist trained at the European School of Aesthetics 15 years ago, specialising in facial treatments and lymphatic drainage. She has worked in the finest spas in the Algarve.', src: '', bio_long: [], services: [] },
  ...
  FR: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Tânia Cavalheiro', role: 'Thérapeute Bien-Être · Spécialiste du visage', bio: 'Masseuse formée à l’École Européenne d’Esthétique il y a 15 ans, spécialisée dans les soins du visage et le drainage lymphatique. Elle a travaillé dans les meilleurs spas de l’Algarve.', src: '', bio_long: [], services: [] },
  ...
  ES: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Tânia Cavalheiro', role: 'Terapeuta de Bienestar · Especialista en Rostro', bio: 'Masajista formada en la Escuela Europea de Estética hace 15 años, especializada en tratamientos faciales y drenaje linfático. Ha trabajado en los mejores spas del Algarve.', src: '', bio_long: [], services: [] },
