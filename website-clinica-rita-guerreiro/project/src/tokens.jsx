...
const TRANSLATIONS = {
  ...
  FR: {
    ...
    hero: {
      ...
      desc: 'Physiothérapie, Ostéopathie, Pilates Clinique, Psychologie et bien plus — dans une clinique à Loulé où chaque personne est accueillie avec attention et soin véritable.',
