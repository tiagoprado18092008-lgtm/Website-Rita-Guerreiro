    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Dra. Marta Belião', role: 'Fisioterapeuta', bio: 'Fisioterapeuta com experiência clínica, hospitalar e de spa, focada na recuperação e no bem-estar de cada paciente.', src: 'assets/fotos/profissional-1.jpg',
          bio_long: ['Licenciada em Fisioterapia, a Dra. Marta Belião possui uma vasta experiência em contexto clínico, hospitalar e de spa, incluindo funções de supervisão em unidades de referência no Algarve.', 'Com uma forte ligação ao Turismo de Saúde, distingue-se pela abordagem atenta e personalizada, orientada para a recuperação e o bem-estar de cada paciente, tanto a nível físico como psicológico.'],
          services: [{ label: 'Fisioterapia', href: '/servico/fisioterapia' }] },
        { name: 'Inês Almeida', role: 'Terapeuta de Saúde e Bem-Estar', bio: 'Auxiliar de fisioterapia há 12 anos, especialista em Massagem Terapêutica e Sacro-craniana e nas propriedades dos óleos essenciais.', src: 'assets/fotos/profissional-2.jpg',
        ...
        { name: 'Dra. Cristina Tengarrinha', role: 'Medicina Tradicional Chinesa e Acupuntura', bio: 'Terapeuta de Medicina Tradicional Chinesa, Acupuntura e Fitoterapia, com formação em Shiatsu e Reflexologia.', src: 'assets/fotos/profissional-3.jpg',
          bio_long: ['Formada em Medicina Chinesa, Acupuntura e Fitoterapia, a Dra. Cristina Tengarrinha é ainda Técnica Auxiliar de Fisioterapia, com formação em Shiatsu e Reflexologia, entre outras áreas da saúde.', 'Reúne uma vasta experiência profissional e uma abordagem próxima e atenta, colocando o seu conhecimento ao serviço do equilíbrio e do bem-estar dos pacientes.'],
        ...
        { name: 'Nome do profissional', role: 'Psicologia & Nutrição', bio: 'Membro da equipa multidisciplinar da clínica, dedicada a um cuidado próximo e atento ao seu bem-estar.', src: 'assets/fotos/profissional-4.jpg',
          bio_long: ['Membro da equipa multidisciplinar da clínica, dedicada a um cuidado próximo e atento ao seu bem-estar.'], services: [] },
      ],
  ...
  EN: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Inês Almeida', role: 'Health & Well-Being Therapist', bio: 'Physiotherapy assistant for 12 years, specialised in Therapeutic and Craniosacral Massage and the properties of essential oils.', src: 'assets/fotos/profissional-2.jpg',
        ...
        { name: 'Cristina Tengarrinha', role: 'Traditional Chinese Medicine & Acupuncture', bio: 'Therapist in Traditional Chinese Medicine, Acupuncture and Phytotherapy, with training in Shiatsu and Reflexology.', src: 'assets/fotos/profissional-3.jpg',
        ...
        { name: 'Professional name', role: 'Psychology & Nutrition', bio: 'A member of the clinic’s multidisciplinary team, dedicated to close, attentive care for your well-being.', src: 'assets/fotos/profissional-4.jpg',
          bio_long: ['A member of the clinic’s multidisciplinary team, dedicated to close, attentive care for your well-being.'], services: [] },
      ],
  ...
  FR: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Inês Almeida', role: 'Thérapeute Santé et Bien-Être', bio: 'Auxiliaire de physiothérapie depuis 12 ans, spécialisée en massage thérapeutique et crânio-sacré et dans les propriétés des huiles essentielles.', src: 'assets/fotos/profissional-2.jpg',
        ...
        { name: 'Cristina Tengarrinha', role: 'Médecine traditionnelle chinoise et acupuncture', bio: 'Thérapeute en médecine traditionnelle chinoise, acupuncture et phytothérapie, avec une formation en shiatsu et réflexologie.', src: 'assets/fotos/profissional-3.jpg',
        ...
        { name: 'Nom du professionnel', role: 'Psychologie & Nutrition', bio: 'Membre de l’équipe pluridisciplinaire de la clinique, dédiée à un accompagnement proche et attentif à votre bien-être.', src: 'assets/fotos/profissional-4.jpg',
          bio_long: ['Membre de l’équipe pluridisciplinaire de la clinique, dédiée à un accompagnement proche et attentif à votre bien-être.'], services: [] },
      ],
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Dra. Marta Belião', role: 'Fisioterapeuta', bio: 'Fisioterapeuta con experiencia clínica, hospitalaria y de spa, centrada en la recuperación y el bienestar de cada paciente.', src: 'assets/fotos/profissional-1.jpg',
          bio_long: ['Licenciada en Fisioterapia, la Dra. Marta Belião cuenta con una amplia experiencia en contexto clínico, hospitalario y de spa, incluyendo funciones de supervisión en centros de referencia del Algarve.', 'Con una fuerte vinculación al Turismo de Salud, se distingue por un enfoque atento y personalizado, orientado a la recuperación y el bienestar de cada paciente, tanto a nivel físico como psicológico.'],
          services: [{ label: 'Fisioterapia', href: '/servico/fisioterapia' }] },
        { name: 'Inês Almeida', role: 'Terapeuta de Salud y Bienestar', bio: 'Auxiliar de fisioterapia desde hace 12 años, especialista en masaje terapéutico y sacrocraneal y en las propiedades de los aceites esenciales.', src: 'assets/fotos/profissional-2.jpg',
        ...
        { name: 'Dra. Cristina Tengarrinha', role: 'Medicina Tradicional China y Acupuntura', bio: 'Terapeuta de Medicina Tradicional China, Acupuntura y Fitoterapia, con formación en Shiatsu y Reflexología.', src: 'assets/fotos/profissional-3.jpg',
          bio_long: ['Formada en Medicina China, Acupuntura y Fitoterapia, la Dra. Cristina Tengarrinha es además Técnica Auxiliar de Fisioterapia, con formación en Shiatsu y Reflexología, entre otras áreas de la salud.', 'Reúne una amplia experiencia profesional y un enfoque cercano y atento, poniendo su conocimiento al servicio del equilibrio y el bienestar de los pacientes.'],
        ...
        { name: 'Nombre del profesional', role: 'Psicología & Nutrición', bio: 'Miembro del equipo multidisciplinar de la clínica, dedicada a un cuidado cercano y atento a su bienestar.', src: 'assets/fotos/profissional-4.jpg',
          bio_long: ['Miembro del equipo multidisciplinar de la clínica, dedicada a un cuidado cercano y atento a su bienestar.'], services: [] },
      ],
