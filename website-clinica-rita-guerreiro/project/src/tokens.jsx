  ...
  PT: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Mafalda Santos', role: 'Terapeuta de Bem-Estar', bio: 'Terapeuta de bem-estar da equipa, dedicada ao relaxamento e ao cuidado de cada pessoa.', src: '', bio_long: [], services: [] },
        ...
        { name: 'Sara Fernandes', role: 'Fisioterapeuta Pediátrica', bio: 'Fisioterapeuta dedicada à saúde e ao desenvolvimento dos mais novos.', src: '', bio_long: [], services: [] },
        { name: 'Raquel Peters', role: 'Psicóloga', bio: 'Psicóloga da equipa, dedicada ao bem-estar emocional e à saúde mental.', src: '', bio_long: [], services: [] },
        { name: 'Ana Rita Correia', role: 'Nutricionista', bio: 'Nutricionista da clínica, focada numa alimentação equilibrada e personalizada.', src: '', bio_long: [], services: [] },
        { name: 'Tânia Cavalheiro', role: 'Terapeuta de Bem-Estar · Especialista em Rosto', bio: 'Terapeuta de bem-estar e especialista em tratamentos de rosto.', src: '', bio_long: [], services: [] },
        ...
        { name: 'João Monteiro', role: 'Personal Trainer', bio: 'Personal trainer da equipa, dedicado ao treino e à condição física de cada pessoa.', src: '', bio_long: [], services: [] },
        { name: 'Fábio Mendinhos', role: 'Terapia de Bowen', bio: 'Terapeuta de Bowen, focado no alívio da dor e no equilíbrio do corpo.', src: '', bio_long: [], services: [] },
      ],
  ...
  EN: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Mafalda Santos', role: 'Well-Being Therapist', bio: 'Well-being therapist on the team, dedicated to relaxation and the care of each person.', src: '', bio_long: [], services: [] },
        ...
        { name: 'Sara Fernandes', role: 'Paediatric Physiotherapist', bio: 'Physiotherapist dedicated to the health and development of the youngest patients.', src: '', bio_long: [], services: [] },
        { name: 'Raquel Peters', role: 'Psychologist', bio: 'Psychologist on the team, dedicated to emotional well-being and mental health.', src: '', bio_long: [], services: [] },
        { name: 'Ana Rita Correia', role: 'Nutritionist', bio: 'Nutritionist at the clinic, focused on balanced, personalised nutrition.', src: '', bio_long: [], services: [] },
        { name: 'Tânia Cavalheiro', role: 'Well-Being Therapist · Facial Specialist', bio: 'Well-being therapist and specialist in facial treatments.', src: '', bio_long: [], services: [] },
        ...
        { name: 'João Monteiro', role: 'Personal Trainer', bio: 'Personal trainer on the team, dedicated to each person’s training and physical condition.', src: '', bio_long: [], services: [] },
        { name: 'Fábio Mendinhos', role: 'Bowen Therapy', bio: 'Bowen therapist, focused on pain relief and the body’s balance.', src: '', bio_long: [], services: [] },
      ],
  ...
  FR: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Mafalda Santos', role: 'Thérapeute Bien-Être', bio: 'Thérapeute bien-être de l’équipe, dédiée à la relaxation et au soin de chaque personne.', src: '', bio_long: [], services: [] },
        ...
        { name: 'Sara Fernandes', role: 'Physiothérapeute pédiatrique', bio: 'Physiothérapeute dédiée à la santé et au développement des plus jeunes.', src: '', bio_long: [], services: [] },
        { name: 'Raquel Peters', role: 'Psychologue', bio: 'Psychologue de l’équipe, dédiée au bien-être émotionnel et à la santé mentale.', src: '', bio_long: [], services: [] },
        { name: 'Ana Rita Correia', role: 'Nutritionniste', bio: 'Nutritionniste de la clinique, axée sur une alimentation équilibrée et personnalisée.', src: '', bio_long: [], services: [] },
        { name: 'Tânia Cavalheiro', role: 'Thérapeute Bien-Être · Spécialiste du visage', bio: 'Thérapeute bien-être et spécialiste des soins du visage.', src: '', bio_long: [], services: [] },
        ...
        { name: 'João Monteiro', role: 'Coach sportif', bio: 'Coach sportif de l’équipe, dédié à l’entraînement et à la condition physique de chaque personne.', src: '', bio_long: [], services: [] },
        { name: 'Fábio Mendinhos', role: 'Thérapie Bowen', bio: 'Thérapeute Bowen, axé sur le soulagement de la douleur et l’équilibre du corps.', src: '', bio_long: [], services: [] },
      ],
  ...
  ES: {
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Mafalda Santos', role: 'Terapeuta de Bienestar', bio: 'Terapeuta de bienestar del equipo, dedicada a la relajación y al cuidado de cada persona.', src: '', bio_long: [], services: [] },
        ...
        { name: 'Sara Fernandes', role: 'Fisioterapeuta Pediátrica', bio: 'Fisioterapeuta dedicada a la salud y al desarrollo de los más pequeños.', src: '', bio_long: [], services: [] },
        { name: 'Raquel Peters', role: 'Psicóloga', bio: 'Psicóloga del equipo, dedicada al bienestar emocional y a la salud mental.', src: '', bio_long: [], services: [] },
        { name: 'Ana Rita Correia', role: 'Nutricionista', bio: 'Nutricionista de la clínica, centrada en una alimentación equilibrada y personalizada.', src: '', bio_long: [], services: [] },
        { name: 'Tânia Cavalheiro', role: 'Terapeuta de Bienestar · Especialista en Rostro', bio: 'Terapeuta de bienestar y especialista en tratamientos de rostro.', src: '', bio_long: [], services: [] },
        ...
        { name: 'João Monteiro', role: 'Entrenador Personal', bio: 'Entrenador personal del equipo, dedicado al entrenamiento y a la condición física de cada persona.', src: '', bio_long: [], services: [] },
        { name: 'Fábio Mendinhos', role: 'Terapia de Bowen', bio: 'Terapeuta de Bowen, centrado en el alivio del dolor y el equilibrio del cuerpo.', src: '', bio_long: [], services: [] },
      ],
