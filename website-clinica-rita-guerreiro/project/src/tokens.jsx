...
const TRANSLATIONS = {
  PT: {
    ...
    hero: {
      ...
      foto_caption: 'A equipa que cuida de si',
      foto_caption_sub: '5 profissionais dedicadas · Loulé',
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Nome do profissional', role: 'Osteopatia & ATM', bio: 'Membro da equipa multidisciplinar da clínica, dedicada a um cuidado próximo e atento ao seu bem-estar.', src: 'assets/fotos/profissional-1.jpg' },
        { name: 'Nome do profissional', role: 'Acupuntura & Terapias', bio: 'Membro da equipa multidisciplinar da clínica, dedicada a um cuidado próximo e atento ao seu bem-estar.', src: 'assets/fotos/profissional-2.jpg' },
        { name: 'Nome do profissional', role: 'Reflexologia & Massagem', bio: 'Membro da equipa multidisciplinar da clínica, dedicada a um cuidado próximo e atento ao seu bem-estar.', src: 'assets/fotos/profissional-3.jpg' },
  ...
  EN: {
    ...
    hero: {
      ...
      foto_caption: 'The team that cares for you',
      foto_caption_sub: '5 dedicated professionals · Loulé',
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Professional name', role: 'Osteopathy & TMJ', bio: 'A member of the clinic’s multidisciplinary team, dedicated to close, attentive care for your well-being.', src: 'assets/fotos/profissional-1.jpg' },
        { name: 'Professional name', role: 'Acupuncture & Therapies', bio: 'A member of the clinic’s multidisciplinary team, dedicated to close, attentive care for your well-being.', src: 'assets/fotos/profissional-2.jpg' },
        { name: 'Professional name', role: 'Reflexology & Massage', bio: 'A member of the clinic’s multidisciplinary team, dedicated to close, attentive care for your well-being.', src: 'assets/fotos/profissional-3.jpg' },
  ...
  FR: {
    ...
    hero: {
      ...
      foto_caption: 'L’équipe qui prend soin de vous',
      foto_caption_sub: '5 professionnelles dévouées · Loulé',
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Nom du professionnel', role: 'Ostéopathie & ATM', bio: 'Membre de l’équipe pluridisciplinaire de la clinique, dédiée à un accompagnement proche et attentif à votre bien-être.', src: 'assets/fotos/profissional-1.jpg' },
        { name: 'Nom du professionnel', role: 'Acupuncture & Thérapies', bio: 'Membre de l’équipe pluridisciplinaire de la clinique, dédiée à un accompagnement proche et attentif à votre bien-être.', src: 'assets/fotos/profissional-2.jpg' },
        { name: 'Nom du professionnel', role: 'Réflexologie & Massage', bio: 'Membre de l’équipe pluridisciplinaire de la clinique, dédiée à un accompagnement proche et attentif à votre bien-être.', src: 'assets/fotos/profissional-3.jpg' },
  ...
  ES: {
    ...
    hero: {
      ...
      foto_caption: 'El equipo que cuida de usted',
      foto_caption_sub: '5 profesionales dedicadas · Loulé',
      next_slot_meta: 'Fisioterapia · 50 min',
      card_name: 'Centro de Terapias Rita Guerreiro',
      card_addr: 'Rua Padre António Vieira 58, Loulé',
    },
    ...
    sobre: {
      ...
      team_members: [
        ...
        { name: 'Nombre del profesional', role: 'Osteopatía & ATM', bio: 'Miembro del equipo multidisciplinar de la clínica, dedicada a un cuidado cercano y atento a su bienestar.', src: 'assets/fotos/profissional-1.jpg' },
        { name: 'Nombre del profesional', role: 'Acupuntura & Terapias', bio: 'Miembro del equipo multidisciplinar de la clínica, dedicada a un cuidado cercano y atento a su bienestar.', src: 'assets/fotos/profissional-2.jpg' },
        { name: 'Nombre del profesional', role: 'Reflexología & Masaje', bio: 'Miembro del equipo multidisciplinar de la clínica, dedicada a un cuidado cercano y atento a su bienestar.', src: 'assets/fotos/profissional-3.jpg' },
