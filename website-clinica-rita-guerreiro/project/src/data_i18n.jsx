  ...
  ES: {
    fisioterapia: {
      ...
      items: {
        ...
        mesoterapia: { name: 'Fisioterapia ATM / Mesoterapia', blurb: 'Tratamiento especializado de la articulación temporomandibular y mesoterapia para dolor e inflamación localizados' },
        acupuntura: { name: 'Fisioterapia Vestibular / Acupuntura', blurb: 'Rehabilitación vestibular para mareos y vértigo, y acupuntura para dolor, estrés y bienestar general' },
      },
    },
    saude: {
...
const SERVICE_DETAIL_I18N = {
  ...
  ES: {
    ...
    mesoterapia: {
      tagline: 'Tratamiento especializado de la ATM y mesoterapia para dolor e inflamación localizados',
      description: 'La Fisioterapia de la ATM trata las disfunciones de la articulación temporomandibular — dolor, bloqueo, chasquidos o rechinar de la mandíbula — con un enfoque manual especializado. La Mesoterapia consiste en aplicar microinyecciones de sustancias activas directamente en las capas superficiales de la piel o tejido subcutáneo, con acción localizada para dolor articular, contracturas y tratamientos estéticos.',
      prices: [
        { label: 'Fisioterapia ATM (50min)', value: '55€' },
        { label: 'Mesoterapia (50min)', value: '50€' },
      ],
      sub: [
        { t: 'ATM — Articulación temporomandibular', d: 'Tratamiento del dolor, bloqueo, chasquidos o rechinar de la mandíbula y alivio de las cefaleas asociadas' },
    ...
    acupuntura: {
      tagline: 'Rehabilitación vestibular y acupuntura — equilibrio, alivio del dolor y bienestar en cada sesión',
      description: 'La Fisioterapia Vestibular trata los mareos, vértigo y desequilibrios mediante maniobras específicas y ejercicios de rehabilitación. La Acupuntura es uno de los pilares de la Medicina Tradicional China con evidencia creciente en el manejo del dolor, estrés, ansiedad e insomnio. En Rita Guerreiro, cada sesión está precedida por una evaluación global de salud para una intervención verdaderamente personalizada.',
      prices: [{ label: 'Por sesión (50min)', value: '45€' }],
      sub: [
        { t: 'Vértigo y mareos', d: 'Maniobras de reposicionamiento y ejercicios de rehabilitación vestibular para el equilibrio' },
